...
import { Layout, Row, Col, Breadcrumb, Card, Affix } from "antd";
        ...
        <div className="container-white">
          ...
          <Row gutter={16}>
            <div className="pageTitle">
              ...
              <p>
                Tweets data in Australia are harvested from Twitter, the number
                of which is about 430,000. These data will help immigrants to
                decide which city in Australia is most suitable for moving in.
                There are five candidates in scope, which are Sydney, Melbourne,
            ...
            <Col className="gutter-row" md={7}>
              <div className="gutter-box chart-text">
                <p>
                  ...
                  percentage of positive tweets is used to define the Happiness
                  Index for each city
                </p>
                <p>Results:</p>
                <ul>
            ...
            <Col className="gutter-row" md={7}>
              <div className="gutter-box chart-text">
                <p>
                  ...
                  which can be used to indicate people's attitudes towards these
                  topics.
                </p>
                <p>Results:</p>
                <ul>
                  <li>1. Most people share positive attitudes in Adelaide.</li>
                  <li>2. Brisbane and Adelaide are two better choices</li>
                </ul>
              </div>
            </Col>
          ...
          <Row gutter={16}>
            ...
            <Col className="gutter-row" md={7}>
              <div className="gutter-box chart-text">
                <p>
                  Although cities have different attitudes towards immigration,
                  people still need to find a city which suits their
                  life-styles. We analysized the word frequency of tweets in
                  each city and categorized them in sit groups.
                </p>
                <p>Results:</p>
                <ul>
                  <li>
                    1. People in Australia like to talk about politics (Hottest
                    Word: Trump).
                  </li>
                  <li>
                  ...
                  <li>
                    3. People in Brisbane and Adelaide enjoy more of nature and
                    sports.
                  </li>
                </ul>
              </div>
